...
- No other module may depend on `misaf/vendra-tenant`. Domain and API modules consume tenancy only through `misaf/vendra-support` (`TenantResolver`, `TenantAwareness`, `BelongsToTenant`). Do not create reverse dependencies.
